...
<head>
    ...
    <title>Welcome to Mobile Learning Animals Report | Data Tables</title>
            ...
            <ul class="nav metismenu" id="side-menu">
              ...
              <li class="active">    
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li><a href="contacts.html">Contacts</a></li>
                        <li><a href="profile.html">Profile</a></li>
                        <li><a href="form_basic.html">Staff Registration</a></li>
                    </ul>
                ...
                <li>    
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li><a href="table_basic.html">Student Performance</a></li>
                    </ul>
                ...
                <li>
                    <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Graph Achievements</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li><a href="table_data_tables.html">Access Frequency</a></li>
                    </ul>
                </li>
